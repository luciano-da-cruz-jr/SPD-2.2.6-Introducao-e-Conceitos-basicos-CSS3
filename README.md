...
Neste repositório contém uma pagina HTML que faz uso das tags section, article, h1, p, a, img, li, ul, ol e estilização CSS3. (This repository contains an HTML page that makes use of the tags section, article, h1, p, a, img, li, ul, ol and CSS3 styling.)
